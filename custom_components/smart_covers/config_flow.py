            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Required("entity_up", default=self.config_entry.data.get("entity_up", "")): selector.EntitySelector(
                        selector.EntitySelectorConfig(
                            domain=["switch", "input_boolean", "binary_sensor"],
                            multiple=False
                        )
                    ),
                    vol.Required("entity_down", default=self.config_entry.data.get("entity_down", "")): selector.EntitySelector(
                        selector.EntitySelectorConfig(
                            domain=["switch", "input_boolean", "binary_sensor"],
                            multiple=False
                        )
                    ...
                    vol.Optional("entity_night_lights", default=self.config_entry.data.get("entity_night_lights")) : selector.EntitySelector(
                        selector.EntitySelectorConfig(
                    ...
                    vol.Required("protect_the_cover", default=self.config_entry.data.get("protect_the_cover")): bool,
                    ...
                    vol.Optional("netamo_speed_entity", default=self.config_entry.data.get("netamo_speed_entity")): selector.EntitySelector(
                        selector.EntitySelectorConfig(
                            domain=["sensor"],
                            device_class=["wind_speed"],
                            multiple=False
                    ...
                    vol.Optional("netamo_gust_entity", default=self.config_entry.data.get("netamo_gust_entity")): selector.EntitySelector(
                        selector.EntitySelectorConfig(
                            domain=["sensor"],
                            device_class=["wind_speed"],
                            multiple=False
                    ...
                    vol.Optional("netamo_rain_entity", default=self.config_entry.data.get("netamo_rain_entity")): selector.EntitySelector(
                        selector.EntitySelectorConfig(
                            domain=["sensor"],
                            device_class=["precipitation"],
                            multiple=False
